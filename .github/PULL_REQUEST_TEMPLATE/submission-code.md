...
- [ ] `contributes` entries each name an `entry` export the module actually exports, branded with the matching `define*` (`defineFilter` / `defineTool` / `defineCommand` / `defineTransition`).
