(function (root, factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).uj = function () {
    return this.tj_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.tj_1[index];
  };
  ...
  protoOf(AtomicRef).vj = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).wj = function () {
  ...
  protoOf(AtomicBoolean).xj = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).wj = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).yj = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).wj = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).zj = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).wj = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).uj);
  //endregion
